...
public class UpdateHealthBar : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.localPosition = new Vector3(-((ParentData.GetMaxHealth() - ParentData.GetHealth()) * MaxHealthSize.x) / (ParentData.GetMaxHealth() * 2), VerticalOffset, 0);
